...
#[AsLiveComponent()]
final class ContactImboxStarred
{
    ...
    {
       return $this->contactRepository->findImboxStarred($this->query, $this->offset, $this->limit);
    }

    public function getTotalContacts()
    {
        return count($this->contactRepository->findImboxStarred($this->query));
    }
